...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-[100] bg-white/70 backdrop-blur-xl border-t border-gray-200/50 pb-safe shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.2)]">
